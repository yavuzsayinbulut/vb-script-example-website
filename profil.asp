...
<section>
  ...
  <div id="subContentHaber" class="subContent">
    ...
    <table border="0" width="25%" height="25%" cellpadding="10" cellspacing="0" style=" font-size: 20px; padding-top: 7%;">
        <tr>
        <td colspan="2" align="center" style="font-size: 20px;">YAVUZ SAYINBULUT - 007</td>
        </tr>
        <tr>
        <td colspan="2" align="center";><img src="profiles/man.png" width="150" height="150"/></td>
        </tr>
     <tr>
           
           <td valign="top" > <table border="1" width="100%" cellpadding="10" cellspacing="0" style=" font-size: 20px; background:#a2b0be">
            <tr>
               <td><b>YAZAR</td>
          ...
          <tr>
               <td>DOSTOYEVSKI</td>
                ...
                <td>Nasıl gidiyor?<BR> <small>>15/04/2021 - 10:15</small></td>
               </tr>
               <tr>
               <td>&emsp;</td>
                <td></td>
        ...
        </table> <br> MESAJINIZ:<textarea name="yorum" rows="10" cols="70"></textarea></td>
     </tr>
   <tr>
